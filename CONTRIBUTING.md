...
1. **Fork the repository**
   ```bash
   git clone https://github.com/Dr-Venom29/Eco-Sync.git
   cd Eco-Sync
   ```
...
3. **Find an issue to work on**
   - Check [Issues](https://github.com/Dr-Venom29/Eco-Sync/issues) for `good-first-issue` or `help-wanted` labels
...
- **Issues**: [Search existing issues](https://github.com/Dr-Venom29/Eco-Sync/issues) or create new ones
- **Discussions**: Use [GitHub Discussions](https://github.com/Dr-Venom29/Eco-Sync/discussions) for questions
